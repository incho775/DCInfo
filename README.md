...
- **IP 정보 표시** — 작성자 IP의 통신사를 판별해 표시 (통신사별 색상: SK 🔴 / KT 🟢 / LG 🔵 / 그 외 🟡), 외국·토르·프록시 식별
...
영구 설치는 [AMO](https://addons.mozilla.org) 서명이 필요합니다. 개발/테스트용 임시 설치:
...
> 임시 부가 기능은 Firefox 재시작 시 사라집니다. Firefox **121 이상** 필요.
